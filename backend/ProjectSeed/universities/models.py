...
class University(models.Model):
    ...
    host = models.ForeignKey(User, on_delete=models.SET_NULL, related_name="hosted_universities", null=True, blank=True)
    admins = models.ManyToManyField(User, blank=True, related_name="administered_universities")
