...
function Top1ProfileCard({profile}) {
  return (
    <Link to={generateProfileRoute(profile.username)} className="top-1-stu-card h-24 w-36 mb-4 pb-5 rounded-2xl relative flex flex-col items-center">
      ...
      <div className="top-1-stu-rise-points-box h-[30%] w-[80%] center gap-1 mt-2 rounded-lg">
          <span className="text-inherit">{profile.rise_points} Rises</span>
